...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Digitalcoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
	...
	{ "wallet",             "sendopreturn",           &sendopreturn,	       true,      true,       false },
    ...
    { "wallet",             "clearwallettransactions",&clearwallettransactions,false,     false,      true},
    { "wallet",             "scanforalltxns",         &scanforalltxns,         false,     false,      true},
    { "wallet",             "scanforstealthtxns",     &scanforstealthtxns,     false,     false,      true},
