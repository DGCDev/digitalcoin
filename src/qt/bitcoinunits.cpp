...
QString BitcoinUnits::id(int unit)
{
    switch(unit)
    {
    case DGC: return QString("btc");
    case mDGC: return QString("mbtc");
    case uDGC: return QString("ubtc");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case mDGC: return QString("Milli-Digitalcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uDGC: return QString("Micro-Digitalcoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
