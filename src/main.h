...
static const int64 MAX_MONEY = 200000000 * COIN; // DigitalCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
/** Switchover time for BDB limit, various timing adjustments, KGW */
static const unsigned int SWITCHOVER_TIME = 2000000000; // DISABLED FOR NOW
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / (2.0/3.0)) / 250; // DigitalCoin: Priority cutoff is 2 digitalcoin day / 250 bytes.
    }
...
public:
    ...
    int64 GetMedianTimePast() const
    {
        ...
        int span = ((pindex->nTime > SWITCHOVER_TIME) ? nKGWMedianTimeSpan : nMedianTimeSpan);
