...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
		...
		( 1288424, uint256("0x0000000000000fb2876e5718d261169794650dc9007f1bfca72cbc432044b9ef"))
		( 1295946, uint256("0x22a267b3251eeda8b86bda51f8dd3c5db8a0884306e3003b93b6e508fe3aed7d"))
		;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1429553720, // * UNIX timestamp of last checkpoint block
        2080135,   // * total number of transactions between genesis and last checkpoint
